...
jobs:
  test:
    ...
    - name: default path
      if: steps.filter.outputs.path1 == 'false' && steps.filter.outputs.path2 == 'false'
      id: directory
      run: echo "::set-output name=directory::./apps/docs"
    ...
    - name: path2
      ...
      id: directory
      run: echo "::set-output name=directory::./apps/web"
